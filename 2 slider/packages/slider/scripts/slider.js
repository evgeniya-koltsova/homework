...
let images = {
    ...
    setNextLeftImage() {
        ...
        currentSlide.classList.add('animate__animated', 'animate__slideInLeft');
        currentSlide.classList.remove('animate__slideInRight');
        this.showImageWithCurrentIdx();
    },
    ...
    setNextRightImage() {
        ...
        let currentSlide = this.slides[this.currentIdx];
        currentSlide.classList.add('animate__animated', 'animate__slideInRight');
        currentSlide.classList.remove('animate__slideInLeft');
        this.showImageWithCurrentIdx();
    },
}
